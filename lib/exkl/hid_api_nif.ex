defmodule Exkl.HidApiNif do
  ...
  @nifs [open: 2, close: 1, write: 2, enumerate: 1]
  ...
  def write(_hid_handle, _data), do: load_error(:hid_nif_library_not_loaded)
  def enumerate(_vendor_id), do: load_error(:hid_nif_library_not_loaded)
